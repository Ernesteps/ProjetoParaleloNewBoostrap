...
class ClienteVO
{
    ...
    {
        $this->cpf_cliente = UtilCTRL::TirarCaracteresEspeciais($cpf_cliente);
    }
    ...
    {
        $this->tel_cliente = UtilCTRL::TirarCaracteresEspeciais($tel_cliente);
    }
